...
class ItemListFragment : Fragment() {
    ...
    // Declare a private immutable property called viewModel of the type InventoryViewModel.
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Initialize the new adapter property using the default constructor, ItemListAdapter{}

        val adapter = ItemListAdapter {
            // Call actionItemListFragmentToItemDetailFragment() method on the ItemListFragmentDirections
            // Passing in the item id to navigation args.
