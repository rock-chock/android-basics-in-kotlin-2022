...
class LetterListFragment : Fragment() {
    ...
    // Declare a lateinit SettingsDataStore class variable to save user preference of layout (Linear/Grid)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Initialize variable of SettingsDataStore and pass in the requireContext()
        ...
        SettingsDataStore.preferenceFlow.asLiveData().observe(
            viewLifecycleOwner,
            // Assign the new layout setting to the isLinearLayoutManager variable. Make a call to the chooseLayout() function to update the RecyclerView layout.
            { value ->
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_switch_layout -> {
                // Set isLinearLayoutManager (a Boolean) to the opposite value
