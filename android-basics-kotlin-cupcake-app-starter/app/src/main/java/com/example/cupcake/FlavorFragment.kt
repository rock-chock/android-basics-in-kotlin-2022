...
class FlavorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.apply {
            ...
            // [viewLifecycleOwner] here is FlavorFragment
            ...
            // Bind layout variable to fragment to be able to set a Binding Listener from layout
            // Explicitly specify the fragment class name via `@` because [this] keyword returns scope it's in (in this case binding)
     ...
     */
    fun goToNextScreen() {
        // Perform action of navigation from fragment to fragment
        findNavController().navigate(R.id.action_flavorFragment_to_pickupFragment)
    }

    // Reset order instance and navigate to Start Fragment
    fun cancelOrder() {
