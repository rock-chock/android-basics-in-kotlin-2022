...
class StartFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Bind layout variable startFragment to the fragment instance [this]
        // This allows to use listener binding in layout and call fragment's methods
    ...
    fun orderCupcake(quantity: Int) {
        // Call a method to set quantity of the shared OrderViewModel
        sharedViewModel.setQuantity(quantity)

        // Check if no flavor is set
        if (sharedViewModel.hasNoFlavorSet()) {
            sharedViewModel.setFlavor(getString(R.string.vanilla))
        }

        // Perform action of navigation from Start fragment to Flavor fragment
