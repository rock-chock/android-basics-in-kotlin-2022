...
/**
 * A public interface that exposes the [getAmphibians] method to the app
 */
interface AmphibianApiService {
    // Declare a suspended function to get the list of amphibians.
    // This function can be called within a coroutine as it's marked with suspend keyword
...
object AmphibianApi {
    val retrofitService: AmphibianApiService by lazy {
        // Use retrofit.create method and pass AmphibianApiService interface with getAmphibians()
